...
// Whiskers, as Nesky's (50 Camera Mistakes, #5-#7, #12): rays from the
...
// position straight back. A blocked whisker says a wall is coming before
...
//
// Every whisker hit is judged by the collision's one rule, once per
// reference an update.
...
namespace mcc::whiskers
{
	...
	// The fraction of the cast the near whiskers found free, 1 when clear.
